        ...
        <td align="center"> <br>
            <div class="container">
                ...
                <div class="mySlides">
                    ...
                    <img src="imgs/vocales/Aa.jpg" alt="imagen-1" onclick="document.getElementById('vocal-a').play()" style="cursor:pointer">
                </div>

                <div class="mySlides">
                    <audio id="vocal-e" src="audio/vocal-e.mp3" ></audio>
                    <img src="imgs/vocales/Ee.jpg" alt="" onclick="document.getElementById('vocal-e').play()" style="cursor:pointer">
                </div>
